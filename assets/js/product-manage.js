...
`,Z.MISSING_INTL_API,n);
    ...
    var wi = "en-US"
      ...
      , Ai = "Email"
      , Ii = "SĐT" //"Phone"
      , Hi = "Giao hàng" //"Delivery"
      , Mi = "Shipping"
      , Bi = "Địa chỉ" //"Address"
      , Ri = "Tỉnh/ Thành phố" //"City"
      , Di = "Quốc gia" //"Country"
      , Ni = "Quận/ Huyện" //"State"
      , Oi = "Mã bưu chính" //"Postal Code"
      , qi = "Phương thức vận chuyển" //"Shipping Method"
      , Ui = "Địa chỉ nhận hàng" //"Shipping Address"
      , Fi = "Nhận tại cửa hàng" //"Pickup at Store"
      , $i = "Cửa hàng" //"Store"
      , Gi = "Giờ làm việc" //"Working Hours"
      , Vi = "Thanh toán" //"Billing"
      , zi = "Tên" //"Billing Name"
      , ji = "Địa chỉ thanh toán" //"Billing Address"
      , Qi = "Ghi chú" //"Note"
