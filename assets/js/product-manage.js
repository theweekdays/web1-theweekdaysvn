...
`,Z.MISSING_INTL_API,n);
    ...
    var wi = "en-US"
      ...
      , da = "Update Cart"
      , ca = "Complete Order"
      , ha = "I agree to the {terms}"
      , ua = "Terms & Conditions"
      , pa = "Privacy Policy"
      , fa = "Refund Policy"
      , ma = "Customer Details"
      , ya = "Shipping and taxes are calculated during checkout."
      , va = "Pick up at {store}"
      , ga = "Order Ready for Pickup"
      , ba = "Estimated Delivery"
      , xa = "Select a Store"
      , _a = "Add Billing Info"
      , wa = "Deliver to Address"
      , Ca = "Not yet selected"
      , Sa = "Select Country"
      , Ea = "Note to Seller"
      , La = "If you have any specific instructions you want to give to the seller, write them here."
      , Ta = "Apply a Tax Exemption"
      , Pa = "Tax Exemption File"
      , ka = "Attach a document or photo of your tax exemption"
      , Aa = "Enter your EU VAT number"
      , Ia = "Tax exemption invalidated"
      , Ha = "The provided tax exemption info could not be applied to the newly selected address."
      , Ma = "Enter coupon or promo code"
      , Ba = "Coupon added"
      , Ra = "Coupon removed"
      , Da = "Order Summary"
      , Na = "Show Summary"
      , Oa = "All prices are in {currency}"
      , qa = "{in_stock, plural, =0 {0 items left in stock} other {Only # left in stock.}}"
      , Ua = "Chỉ được mua tối đa {max_quantity} sản phẩm này"
      , Fa = "Unable to load shopping cart."
      , $a = "Giỏ hàng của bạn đang trống."
      , Ga = "Couldn't complete checkout."
      , Va = "VAT number is invalid or can't be used in cross-border transactions."
      , za = "VAT could't be validated."
      , ja = "Product delivery is not available. Please contact us."
      , Qa = "The store is unable to ship your order to this address."
      , Xa = "Coupon không hợp lệ."
      , Za = "Coupon cannot be applied to any of the products in the cart."
      ...
      , Ya = "One or more products are out of stock."
      , Ka = "Only {available} {product} available in the store. There {in_cart, plural, =1 {is} other {are}} {in_cart} in your cart."
      , es = "Invalid coupon in cart. Please remove the coupon to continue with checkout."
      , ts = "The products cannot be shipped to the provided address."
      , rs = "The minimum product value for placing an order is {min_val}."
      , is = "Cart value exceeds supported limits."
      , as = "The minimum purchase amount for {product} is at least {min_qty}. There {in_cart, plural, =1 {is} other {are}} {in_cart} in your cart."
      , ss = "A maximum of {max_qty} {product} can be purchased per customer. {in_cart, plural, =0 {} =1 {There is 1 already in your cart.} other {There are # already in your cart.}}"
      ...
      , hs = "Tìm kiếm" //"Search"
      , us = "Tìm kiếm sản phẩm" //"Search Products"
